const translations = {
  en: {
    ...
    productFlavorB: "Flavor: Classic tobacco.",
    productStrengthB: "Strength: Medium.",
    productSmoothnessB: "Smoothness: Balanced draw.",
    productFlavorS: "Flavor: Rich tobacco.",
    productStrengthS: "Strength: Full.",
    productSmoothnessS: "Smoothness: Bold finish.",
    productFlavorU: "Flavor: Smooth tobacco blend.",
    productStrengthU: "Strength: Mild to medium.",
    productSmoothnessU: "Smoothness: Clean and easy draw.",
    productFlavorK: "Flavor: Clove-tobacco blend.",
    productStrengthK: "Strength: Medium.",
    productSmoothnessK: "Smoothness: Warm, spiced finish.",
    productFlavorV: "Flavor: Bold tobacco blend.",
    productStrengthV: "Strength: Full.",
    productSmoothnessV: "Smoothness: Strong, rounded finish.",
  ...
  ms: {
    ...
    productFlavorB: "Perisa: Tembakau klasik.",
    productStrengthB: "Kekuatan: Sederhana.",
    productSmoothnessB: "Kelancaran: Tarikan seimbang.",
    productFlavorS: "Perisa: Tembakau lebih kaya.",
    productStrengthS: "Kekuatan: Penuh.",
    productSmoothnessS: "Kelancaran: Penamat yang lebih tegas.",
    productFlavorU: "Perisa: Campuran tembakau yang lebih lembut.",
    productStrengthU: "Kekuatan: Ringan ke sederhana.",
    productSmoothnessU: "Kelancaran: Tarikan bersih dan mudah.",
    productFlavorK: "Perisa: Campuran cengkih dan tembakau.",
    productStrengthK: "Kekuatan: Sederhana.",
    productSmoothnessK: "Kelancaran: Penamat hangat dan berempah.",
    productFlavorV: "Perisa: Campuran tembakau yang lebih berani.",
    productStrengthV: "Kekuatan: Penuh.",
    productSmoothnessV: "Kelancaran: Penamat kuat dan seimbang.",
  ...
  zh: {
    ...
    featuredLabel: "主打产品",
    productFlavorB: "风味：经典烟草。",
    productStrengthB: "浓度：中等。",
    productSmoothnessB: "顺滑度：口感均衡。",
    productFlavorS: "风味：浓郁烟草。",
    productStrengthS: "浓度：饱满。",
    productSmoothnessS: "顺滑度：收尾更强烈。",
    productFlavorU: "风味：柔和烟草混合。",
    productStrengthU: "浓度：轻至中等。",
    productSmoothnessU: "顺滑度：入口干净顺畅。",
    productFlavorK: "风味：丁香与烟草混合。",
    productStrengthK: "浓度：中等。",
    productSmoothnessK: "顺滑度：温暖辛香收尾。",
    productFlavorV: "风味：浓烈烟草混合。",
    productStrengthV: "浓度：饱满。",
    productSmoothnessV: "顺滑度：厚实圆润。",
    contactKicker: "联系",
