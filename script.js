const translations = {
  en: {
    ...
    productCardCopy: "Contact us on WhatsApp for product details and availability.",
  ...
  ms: {
    ...
    productCardCopy: "Hubungi kami di WhatsApp untuk butiran produk dan ketersediaan.",
  ...
  zh: {
    ...
    featuredLabel: "主打产品",
    productCardCopy: "欢迎通过 WhatsApp 联系我们了解产品详情与供应情况。",
    contactKicker: "联系",
